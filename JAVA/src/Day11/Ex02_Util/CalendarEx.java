...
public class CalendarEx {
	...
	public static void main(String[] args) {
		Calendar now = Calendar.getInstance(); // 객체생성 후 now에 저장
		...
		// 오늘 ~ 종강일 D-day
		// getTimeInMillis() : 날짜를 ms(밀리초) eksdnlRKwl tntwkfh qksghks
		...
		System.out.println("1970년 1월 1일 ~ 종강 날짜까지 일 수 " + testT);
		System.out.println("D-Day : " + (testT-nowT) + "일");

		if( now.before(test) ) { // 현재 날짜 기준 비교 날짜 전 이면 true
