...
public class MathEx {
	public static void main(String[] args) {
		...
		System.out.println(Math.PI); 			// 3.1415926....(원주율)
		System.out.println(Math.ceil(3.125)); 	// 올림: 해당 수 보다 큰 정수 중 가장 작은 수
		System.out.println(Math.floor(3.75)); 	// 올림: 해당 수 보다 작은 정수 중 가장 큰 수
