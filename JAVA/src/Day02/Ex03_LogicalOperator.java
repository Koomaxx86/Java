...
public class Ex03_LogicalOperator {
	...
	public static void main(String[] args) {
		...
		// OR(||) --"|" 쓰는 법 ㅣ shift + (원화표시)
		// A OR B : A와 B 둘 중 하나라도 true 일 때, 결과가 true
		// A B 결과
		// -------------
		// F F F
		// T F T
		// F T T
		// T T T
		System.out.println(true || true); //쇼트서킷
		System.out.println(true || false); //쇼트서킷
		System.out.println((5 < 20) || (5 > 2)); //쇼트서킷
		System.out.println(true || true); //쇼트서킷
		System.out.println();
